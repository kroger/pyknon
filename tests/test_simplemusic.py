...
class LilyTest(unittest.TestCase):
    def test_note_to_lily(self):
        self.assertEqual(music.note_to_lily(4), 'e!')
        self.assertEqual(music.note_to_lily(0), 'c!')
        self.assertEqual(music.note_to_lily(6), 'fis!')

    def test_notes_to_lily(self):
        self.assertEqual(music.notes_to_lily([0, 6, 11]), "c! fis! b!")
    
    def test_notes_as_lily_chord(self):
        result = music.notes_as_lily_chord([0, 4, 7])
